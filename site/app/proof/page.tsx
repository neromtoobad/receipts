        ...
        <Section eyebrow="onchain" title="Everything here is" accent="a hash or a measurement.">
          <div style={{ display: 'grid', gap: 12,
            ...
            <Proofcard k="Virtuals · ACP job 75820" v="completed"
              sub="VERTEX hired AUGUR on Base mainnet. The deliverable names which source moved it and which it discounted by trust weight — weights only earned by paying and watching them resolve."
